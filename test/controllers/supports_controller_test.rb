...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { department: @support.department, followup: @support.followup, problem: @support.problem, time: @support.time } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { department: @support.department, followup: @support.followup, problem: @support.problem, time: @support.time } }
